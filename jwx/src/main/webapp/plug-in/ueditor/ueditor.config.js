...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,imagePath:"http://resourcesa.1shiliu.com/files/"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ...
        , toolbars:[[ "source","bold","italic","underline","|","insertorderedlist","insertunorderedlist","link","|","insertimage","|",'removeformat','forecolor','backcolor',"insertvideo","preview","fullscreen","fontfamily","fontsize","paragraph","justifyleft","justifyright","justifycenter","justifyjustify","horizontal","formatmatch"]]
        /* 
