    ...
    var Popup = (function () {
        ...
        Popup.prototype = {
            ...
            show: function () {
                ...
                if (!_this.hideTitle) {
                    //markup += '<header><i class="car-popup-header-img"></i><span>' + this.title + '</span><a href="javascript:;" class="car-popup-cancel ' + this.cancelClass + '"></a></header>';
                	markup += '<header><i class="car-popup-header-img"></i><span>' + this.title + '</span><a href="javascript:;" class="car-popup-cancel close"></a></header>';
                }
