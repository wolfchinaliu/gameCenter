...
<t:datagrid name="typeGridTree" title="数据字典管理" actionUrl="systemController.do?typeGridTree" idField="id" treegrid="true" pagination="false">
	...
	<t:dgToolBar title="字典分类录入" icon="icon-add" url="systemController.do?aouTypeGroup" funname="add"></t:dgToolBar>
	<t:dgToolBar title="字典值录入" icon="icon-add" funname="typeGridTree_AddType"></t:dgToolBar>
