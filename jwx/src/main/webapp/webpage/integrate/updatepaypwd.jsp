...
<article class="container">
    ...
    <section class="main">
        <div class="valid-box">
	        <p class="td-24 cl-333">修改密码关系到您的账户安全，请使用账户绑定的手机号进行验证：</p>
        </div>
            ...
            <form method="post" action="#">
                <ul class="form-list form-list-valid">
                    <li class="clx mb-2">
                        ...
                        重置密码：<input id="pwd" name= "paymentpwd" type="password" class="text fl bg-ccc" placeholder="6个数字" value=""/>
                    </li>
                    <li class="clx mb-2">
                        
                        再次输入：<input id="oldpwd" name= "paymentpwd" type="password" class="text fl bg-ccc" placeholder="6个数字" value=""/>
                    </li>
                    <li class="clx mb-2">
   	        ...
   	        success: function (data) {
                if(data.flag == true){
                    ...
                    window.setTimeout(function(){
                            ...
                            window.location.href = "integrate.do?tests&accountid=${accountid}&openId=${openId}";
