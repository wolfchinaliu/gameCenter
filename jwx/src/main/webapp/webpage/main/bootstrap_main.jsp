...
<div class="container-fluid"><a class="brand" href="http://www.soft8.com.cn" target="_blank">微管理系统 &nbsp;&nbsp;<span class="slogan"></span></a>
...
<ul class="footer-links">
	<li style="display: inline;">&copy; 版权所有<a href="http://www.soft8.com.cn" title="JEECG Framework 3.4.3 GA">JEECG Framework 3.4.3 GA</a></li>
	<li style="display: inline;">&nbsp;(推荐谷歌浏览器，获得更快响应速度) 技术支持:<a title="JEECG Framework 3.4.3 GA版本" href="http://www.soft8.com.cn">JEECG Framework 3.4.3 GA</a></li>
</ul>
</div>
</footer>-->
