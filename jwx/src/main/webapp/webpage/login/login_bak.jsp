...
<body>
                        ...
                        <div style="float: right; padding: 3px 0; margin-right: -12px;">
                            <div>
                                <ul class="uibutton-group">
                                    ...
                                    <li><a class="uibutton normal" href="registerController.do?goRegister" id="but_reg">注册</a></li>
    ...
    <div class="clear"></div>
    <div id="versionBar">
        <div class="copyright"> <span class="tip">WX (推荐使用IE8+,谷歌浏览器可以获得更快,更安全的页面响应速度)</span></div>
    </div>
    <!-- Link JScript-->
