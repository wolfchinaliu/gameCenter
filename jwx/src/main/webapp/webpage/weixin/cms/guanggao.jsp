		...
		<div class="media_preview_area">
 		...
 		<div class="media_edit_area" id="js_appmsg_editor">	
			<div class="appmsg_editor" style="margin-top: 0px;">
		 		<div class="inner">
					<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="guanggaoController.do?save">
					<input id="id" name="id" type="hidden" value="${adPage.id }">
					<input type="hidden" name="accountid" value="${adPage.accountid}">
					<input type="hidden" name="imageName" id="imageName" value="${adPage.imageName}">
					<table cellpadding="0" cellspacing="1" class="formtable">
						...
						<tr>
							...
							<td class="value">
								<input class="inputxt" id="url" name="url" style="width: 300px" value="${adPage.url}">
								<span class="Validform_checktip"></span>
