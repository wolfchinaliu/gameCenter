  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="weixinCmsSiteController.do?doAdd" tiptype="1">
		...
		<table style="width:100%;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<table>
						<tr>
							<c:forEach items="${weixinCmsStyleList}" var="weixinCmsStyle" begin="0" end="2">
								<td align="center" style="background: white;">
									...
									<input  type="radio" id="siteTemplateStyle" name="siteTemplateStyle" value="${weixinCmsStyle.id}" >
									</div>
								</td>
							</c:forEach>
						</tr>
						<c:if test="${fn:length(weixinCmsStyleList) > 3}">

							<tr>
							<c:forEach items="${weixinCmsStyleList}" var="weixinCmsStyle" begin="3" end="5">
								<td align="center" style="background: white;">
								
									<div style="width:180px;height:230px;border:#CCCCCC solid 1px;background: white;margin-right: 10px;font-size: 12px;font-weight: 700;">
									<img src="${weixinCmsStyle.reviewImgUrl}" style="width:180px;height: 230px;">
									${weixinCmsStyle.templateName}
									</div>
									<input  type="radio" id="siteTemplateStyle" name="siteTemplateStyle" value="${weixinCmsStyle.id}">
					...
					<%-- 
							<t:dictSelect field="siteTemplateStyle"  dictTable="weixin_cms_style" dictField="id" dictText="template_name" defaultVal="${weixinCmsSitePage.siteTemsplateStyle}" ></t:dictSelect>
							<span class="Validform_checktip"></span>
