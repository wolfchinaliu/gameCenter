...
<div class="easyui-layout" fit="true" style="border: 0px;">
  ...
  <t:datagrid name="weixinCmsSiteList" checkbox="false" fitColumns="true" title="微官网信息" actionUrl="weixinCmsSiteController.do?datagrid" idField="id" fit="true" queryMode="group">
   <t:dgCol title="主键"  field="id"  hidden="false"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="创建人名称"  field="createName"  hidden="false"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="创建日期"  field="createDate"  hidden="false"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="修改人名称"  field="updateName"  hidden="false"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="修改日期"  field="updateDate"  hidden="false"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="官网名称"  field="siteName"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="公司电话"  field="companyTel"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="官网logo"  field="siteLogo"  hidden="true"  queryMode="single"  image="true" imageSize="100,50" ></t:dgCol>
   <t:dgCol title="官网模板样式"  field="siteTemplateStyle"  dictionary="weixin_cms_style,id,template_name,accountid='${sessionScope.WEIXIN_ACCOUNT.id}'" hidden="true"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="公众账号原始ID"  field="accountid"  hidden="false"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="操作" field="opt" width="100"></t:dgCol>
   
   <t:dgFunOpt funname="goUpdateItem(id)" title="基本信息"></t:dgFunOpt>
   <t:dgFunOpt funname="goUpdateTemplate(id)" title="模板设置"></t:dgFunOpt>
...
function goUpdateItem(id){
		add('官网信息','weixinCmsSiteController.do?toUpdate&id='+id,'weixinCmsSiteList' ,'100%', '100%');
}
function goUpdateTemplate(id){
	add('模板设置','weixinCmsSiteController.do?goUpdateTemplate&id='+id,'weixinCmsSiteList' ,'100%', '100%');
}
//导入
function ImportXls() {
