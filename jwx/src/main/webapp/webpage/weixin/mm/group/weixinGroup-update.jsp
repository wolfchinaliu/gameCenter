...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="weixinGroupController.do?doUpdate" tiptype="1">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="groupName" name="groupName" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${weixinGroupPage.groupName}'>
