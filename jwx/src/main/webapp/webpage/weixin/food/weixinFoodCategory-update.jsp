...
<html>
 <head>
  ...
  $(function () {
      ...
      //编辑时初始化图片预览
      var name = "${weixinFoodCategoryPage.title}";
      var titleImg = "${weixinFoodCategoryPage.imgurl}";
      if(name != ""){
          $("#imageTitle").html(name);
      }
      if(titleImg != ""){
          $("#imageShow").html('<img src="${weixinFoodCategoryPage.imgurl}" width="100%" height="160" />');
      }
  });
		...
		<div class="media_preview_area">
 		...
 		<div class="media_edit_area" id="js_appmsg_editor">	
			<div class="appmsg_editor" style="margin-top: 0px;">
		 		<div class="inner">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="weixinFoodCategoryController.do?doAdd" tiptype="1">
					<input id="id" name="id" type="hidden" value="${weixinFoodCategoryPage.id }">
					<input id="createName" name="createName" type="hidden" value="${weixinFoodCategoryPage.createName }">
					<input id="createDate" name="createDate" type="hidden" value="${weixinFoodCategoryPage.createDate }">
					<input id="updateName" name="updateName" type="hidden" value="${weixinFoodCategoryPage.updateName }">
					<input id="updateDate" name="updateDate" type="hidden" value="${weixinFoodCategoryPage.updateDate }">
					<input id="sellerId" name="sellerId" type="hidden" value="${weixinFoodCategoryPage.sellerId }">
		<table  cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	<input id="name" name="name" type="text" style="width: 150px" class="inputxt" datatype="*" value='${weixinFoodCategoryPage.name}'>
							<span class="Validform_checktip">请输入菜品分类</span>
				...
				<tr>
							...
							<td class="value">
							    ...
							    <input id="imgurl" name="imgurl" type="hidden" nullmsg="请添加图片" value="${weixinFoodCategoryPage.imgurl}">
				...
				<tr>
					...
					<td class="value">
					     	<input id="tags" name="tags" type="text" style="width: 150px" class="inputxt" value='${weixinFoodCategoryPage.tags}'>
							<span class="Validform_checktip"></span>
