...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="weixinLotteryList"  fitColumns="false" title="${type == 101?'答题':'答题' }" actionUrl="weixinActivityController.do?datagrid&type=${type}" idField="id" fit="true" queryMode="group">
   ...
   <t:dgFunOpt funname="showQuestion(id)" title="试题列表" ></t:dgFunOpt>
   ...
   <t:dgToolBar title="录入" icon="icon-add" url="weixinActivityController.do?goEdit&type=${type }" funname="add"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="icon-edit" url="weixinActivityController.do?goEdit&type=${type }" funname="update"></t:dgToolBar>
 ...
 <script type="text/javascript">
     function updateLottery(id){
  	...
  	function showPrize(id){
  		...
  		addGroupMember("中奖记录列表", addurl, 850, 450);
  	}
