...
<html>
 <head>
  ...
  $(function () {
      ...
      //编辑时初始化图片预览
      var name = "${weixinShopCategoryPage.title}", imgurl = "${weixinShopCategoryPage.imgurl}";
      if(name != ""){
		...
		<div class="media_preview_area">
 		...
 		<div class="media_edit_area" id="js_appmsg_editor">	
			<div class="appmsg_editor" style="margin-top: 0px;">
		 		<div class="inner">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="weixinShopCategoryController.do?doAdd" tiptype="1">
