...
<div class="main_bd">
  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="weixinShopGoodsController.do?doUpdate" tiptype="1">
		...
		<table cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
					     	 <input id="price" name="price" type="text" datatype="/^[0-9]+(.[0-9]{1,2})?$/" style="width: 150px" class="inputxt" value="${weixinShopGoodsPage.price}">
							<span class="Validform_checktip">最多保留两位小数</span>
				...
				<tr>
					...
					<td class="value">
							...
							<span class="Validform_checktip">可不填，代表没有优惠</span>
				...
				<tr>
					...
					<td class="value">
						<t:dictSelect field="isNew" typeGroupCode="is_new" hasLabel="false" type="select" defaultVal="${weixinShopGoodsPage.isNew}"></t:dictSelect>
					...
					<td class="value">
						<t:dictSelect field="isHot" typeGroupCode="is_hot" hasLabel="false" type="select" defaultVal="${weixinShopGoodsPage.isHot}"></t:dictSelect>
							<span class="Validform_checktip"></span>
