...
<script type="text/javascript">
		$(function() {
			...
			$("#sendMessage").click(function() {
				...
				$.ajax({
					url : "weixinMessageController.do?doAdd",
					method : "POST",
					dataType : "JSON",
					data : {
						"msgtype" : msgtype,
			...
			$("#sendMessage").click(function() {
				...
				var options = {  
						   ...
						   url : "weixinMessageController.do?doAdd",//默认是form的action， 如果申明，则会覆盖  
			...
			$(".zleft").click(
				function() {
					...
					if (checkedPic == 'mpnews') {
						...
						var imagePath = mediaId[1];
						$(".c_bj").css("text-align", "center");
						var htmlContent = "<a class=\"title_wrp\" href=\"javascript:;\" title=\"点击播放\"><span class='icon icon_lh' style=\"background-color:#c5c6c8!important;background:url(https://res.wx.qq.com/mpres/zh_CN/htmledition/comm_htmledition/style/widget/media_z23182d.png)0 -422px no-repeat;\" src=\""+imagePath+"\" ></span>";
...
<t:formvalid formid="formobj" dialog="true" 
	...
	<div class="jmain">
		<div class="jtit">
			<!--list1-->
			<div class="list1">
				<div class="jtxt">发送对象</div>
				<div class="jcont">
					
							<input id="receiveUserId" name="receiveUserId" type="hidden" value="${receiveUserId }" style="width: 150px" class="inputxt" >
