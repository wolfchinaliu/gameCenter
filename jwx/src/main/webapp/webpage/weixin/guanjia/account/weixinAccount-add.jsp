  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="weixinAccountController.do?doAdd" tiptype="1">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="accountname" name="accountname" type="text" style="width: 250px" class="inputxt" datatype="*">
				...
				<tr>
					...
					<td class="value">
					     	 <input id="accounttoken" name="accounttoken" type="text" style="width: 250px" class="inputxt" datatype="*" value="${weixinAccountPage.accounttoken}" readonly="readonly">
							<span class="Validform_checktip">必填</span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="weixin_accountid" name="weixin_accountid" type="text" style="width: 250px" class="inputxt" datatype="*">
							<span class="Validform_checktip">必填</span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="accountappid" name="accountappid" type="text" style="width: 250px" class="inputxt" datatype="*">
							<span class="Validform_checktip">必填</span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="accountappsecret" name="accountappsecret" type="text" style="width: 250px" class="inputxt"  datatype="*">
							<span class="Validform_checktip">必填</span>
