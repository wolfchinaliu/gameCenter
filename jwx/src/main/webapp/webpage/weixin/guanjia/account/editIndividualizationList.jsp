      ...
      <div class="appmsg_content" id="js_appmsg_preview">
        ...
        <div id="files" class="files">
          <i style="height:160px;overflow:hidden;display:inline-block;width:100%;"><img
                  src="${weixinIndividualizationController.logo }" width="100%" height="160"/></i>
        </div>
    ...
    <div class="appmsg_editor" style="margin-top: 0px;">
      <div class="inner" style="min-height: 100px;">
        <t:formvalid formid="formobjNew" dialog="true" usePlugin="password" layout="table"
                     action="weixinIndividualizationController.do?doUpdate" tiptype="1">
          ...
          <table style="width: 450px;" cellpadding="0" cellspacing="1" class="formtable">
            <tr>
              ...
              <td class="value">
                <input id="acctListName" name="name" type="text" value="${weixinIndividualizationController.name }"
         ...
         Logo上传:
              ...
              <td class="value">
								<span class="btn btn-success fileinput-button">
							        ...
							        <input id="imagepath" name="logo" type="hidden" value="${weixinIndividualizationController.logo }"
