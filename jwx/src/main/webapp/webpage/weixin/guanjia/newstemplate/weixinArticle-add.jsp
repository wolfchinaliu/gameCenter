...
//				document.all.innerurl.style.display='none'
    ...
    var url = 'weixinArticleController.do?uploadthumb',
        uploadButton = $('<button/>')
 			...
 			<div class="appmsg_editor" style="margin-top: 0px;">
				...
				<table style="width: 500px;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value">
							<input id="orders" name="orders" type="text" style="width: 150px" class="inputxt" datatype="*" onkeyup="this.value=this.value.replace(/\D/g,'')"  onafterpaste="this.value=this.value.replace(/\D/g,'')">
							<span class="Validform_checktip"></span>
