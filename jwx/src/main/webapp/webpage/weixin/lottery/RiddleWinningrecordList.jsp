...
<div class="easyui-layout" fit="true">
  <div region="center" style="padding:1px;">
    <t:datagrid name="weixinWinningrecordList" fitColumns="false" title="中奖记录" actionUrl="weixinGuessRiddlesController.do?datagridList&hdid=${hdId}" idField="id" fit="true" queryMode="group">
      ...
      <t:dgCol title="获得流量(单位:M)"  field="winedFlow"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
