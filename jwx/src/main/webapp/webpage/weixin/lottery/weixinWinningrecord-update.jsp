...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="weixinWinningrecordController.do?doUpdate" tiptype="1">
					...
					<tr>
						...
						<td class="value">
									  <input id="addtime" name="addtime" type="text" style="width: 150px" 
						      						class="Wdate" onClick="WdatePicker()"
						      						 ...
						      						 value='<fmt:formatDate value='${weixinWinningrecordPage.addtime}' type="date" pattern="yyyy-MM-dd"/>'>    
						...
						<td class="value">
						     	 <input id="hdid" name="hdid" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${weixinWinningrecordPage.hdid}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="mobile" name="mobile" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${weixinWinningrecordPage.mobile}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="openid" name="openid" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${weixinWinningrecordPage.openid}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="prize" name="prize" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${weixinWinningrecordPage.prize}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="accountid" name="accountid" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${weixinWinningrecordPage.accountid}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="province" name="province" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${weixinWinningrecordPage.province}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="city" name="city" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${weixinWinningrecordPage.city}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="district" name="district" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${weixinWinningrecordPage.district}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="address" name="address" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${weixinWinningrecordPage.address}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="zipcode" name="zipcode" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${weixinWinningrecordPage.zipcode}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="name" name="name" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${weixinWinningrecordPage.name}'>
							<span class="Validform_checktip"></span>
