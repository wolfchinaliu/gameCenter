...
<t:formvalid formid="formobj" dialog="true" usePlugin="password"
    ...
    <table style="width: 600px;" cellpadding="0" cellspacing="1"
        ...
        <tr>
            ...
            <td class="value"><input id="forthprize" name="forthprize"
                                     type="text" style="width: 150px" class="inputxt">M <span
                    class="Validform_checktip"></span> <label class="Validform_label"
                                                              style="display: none;">四等奖流量值</label></td>
            <td align="right"><label class="Validform_label">
                四等奖数量: </label></td>
            <td class="value"><input id="forthprizetotal"
        ...
        <tr>
            <td align="right"><label class="Validform_label">
                四等奖概率: </label></td>
            <td class="value" colspan="3"><input id="forthprizeProb"
        ...
        <tr>
            ...
            <td class="value"><input id="fifthprize" name="fifthprize"
                                     type="text" style="width: 150px" class="inputxt">M <span
                    class="Validform_checktip"></span> <label class="Validform_label"
                                                              style="display: none;">五等奖流量值</label></td>
            <td align="right"><label class="Validform_label">
                五等奖数量: </label></td>
            <td class="value"><input id="fifthprizetotal"
        ...
        <tr>
            <td align="right"><label class="Validform_label">
                五等奖概率: </label></td>
            <td class="value" colspan="3"><input id="fifthprizeProb"
        ...
        <tr>
            ...
            <td class="value"><input id="sixthprize" name="sixthprize"
                                     type="text" style="width: 150px" class="inputxt">M <span
                    class="Validform_checktip"></span> <label class="Validform_label"
                                                              style="display: none;"> 六等奖流量值</label></td>
            <td align="right"><label class="Validform_label">
                六等奖数量: </label></td>
            <td class="value"><input id="sixthprizetotal"
        ...
        <tr>
            <td align="right"><label class="Validform_label">
                六等奖概率: </label></td>
            <td  class="value" colspan="3"><input id="sixthprizeProb"
