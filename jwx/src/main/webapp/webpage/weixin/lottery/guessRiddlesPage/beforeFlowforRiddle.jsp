...
<article class="container">
    <section class="main">
        ...
        <p class="main-msg main-text-red">
            猜灯谜活动将在${starttime}至${endtime}期间开始，敬请期待。
        </p>

        <%--<div class="main-btn">--%>
            <%--&lt;%&ndash;<a href="javascript:;" class="ui-btn ui-btn-3">浪费表情</a>&ndash;%&gt;--%>
...
<script>
//    function makeMore() {
//        window.location.href = "guessRiddlesController.do?NoattentionPublicNum&accountid=" + $('#accountid').val() + "";
//    }
