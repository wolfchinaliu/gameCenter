...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="weixinDrawrecordController.do?doUpdate" tiptype="1">
						...
						<td class="value">
									  <input id="addtime" name="addtime" type="text" style="width: 150px" 
						      						class="Wdate" onClick="WdatePicker()"
						      						 ...
						      						 value='<fmt:formatDate value='${weixinDrawrecordPage.addtime}' type="date" pattern="yyyy-MM-dd"/>'>    
					...
					<tr>
						...
						<td class="value">
						     	 <input id="hdid" name="hdid" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${weixinDrawrecordPage.hdid}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="nickname" name="nickname" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${weixinDrawrecordPage.nickname}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="opendid" name="opendid" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${weixinDrawrecordPage.opendid}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="total" name="total" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${weixinDrawrecordPage.total}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="accountid" name="accountid" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${weixinDrawrecordPage.accountid}'>
							<span class="Validform_checktip"></span>
