...
<div class="easyui-layout" fit="true" style="border: 0px;">
  ...
  <t:datagrid name="weixinSourceList" checkbox="true" fitColumns="false" title="素材管理" actionUrl="weixinSourceController.do?datagrid&type=image" idField="id" fit="true" queryMode="group">
   <t:dgCol title="主键"  field="id"  hidden="false"  queryMode="single"  width="120"></t:dgCol>
   
   <t:dgCol title="微信资源编号"  field="mediaId"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="素材类型"  field="sourceType"  hidden="true" queryMode="single" replace="图片_image,语音_voice,视频_video"  width="120"></t:dgCol>
   <t:dgCol title="缩略图"  field="sourcePath"  hidden="true" image="true" imageSize="40,40" queryMode="single"  width="120">
   ...
   <t:dgToolBar title="查看" icon="icon-search" url="weixinSourceController.do?goView&type=image" funname="detail"></t:dgToolBar>
