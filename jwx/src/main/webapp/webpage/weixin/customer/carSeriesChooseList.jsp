					...
					.datagrid(
							{
								idField : 'id',
								title : '选择分类',
								url : 'carSeriesController.do?datagrid&field=id,name,logo,carBrandEntity.brandName,',
								fit : true,
								loadMsg : '数据加载中...',
								pageSize : 10,
								pagination : true,
								...
								columns : [ [
										...
										{
											field : 'carBrandEntity.brandName',
											title : '品牌名称',
											query:true,
											width : 120,
											sortable : true
										...
										},
										{
											...
											formatter : function(value, rec,
													index) {
												return '<img width="100" height="50" border="0" src="'+value+'"/>';
											}
										} ] ],
