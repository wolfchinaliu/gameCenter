...
<html>
 ...
 <div class="main_bd">
  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="weixinLocationController.do?doUpdate" tiptype="1">
					...
					<input id="businessName" name="businessName" type="hidden"  value="${weixinLocationPage.businessName}">
					<input id="province" name="province" type="hidden"  value="${weixinLocationPage.province}">
					<input id="city" name="city" type="hidden"  value="${weixinLocationPage.city}">
					<input id="district" name="district" type="hidden"  value="${weixinLocationPage.district}">
					<input id="address" name="address" type="hidden"  value="${weixinLocationPage.address}">
					<input id="category" name="category" type="hidden"  value="${weixinLocationPage.category}">
					<input id="longitude" name="longitude" type="hidden"  value="${weixinLocationPage.longitude}">
					<input id="latitude" name="latitude" type="hidden"  value="${weixinLocationPage.latitude}">
		
		<div style="border: solid #f7cc8f 1px;background: #FFEFCE;margin:10px 1px 10px 1px;;vertical-align: middle;height: 30px;" id="point_title">
			 	<p style="padding-left: 15px;height: 30px;vertical-align: middle;padding-top: 5px;"><b>基本信息</b> 基本信息不可修改</p>
		</div>
			<table cellpadding="0" cellspacing="1" class="formtable">
				<tr height="35px">
					<td  class="Validform_label" align="right" width="100px">
				...
				<tr height="35px">
					<td align="right" class="Validform_label">
				...
				<tr height="35px">
					...
					<td class="value">
							${weixinLocationPage.province}${weixinLocationPage.city}${weixinLocationPage.district}
			...
			<div style="border: solid #f7cc8f 1px;background: #FFEFCE;margin:10px 1px 10px 1px;height: 30px;" id="point_title">
			 	<p style="padding-left: 15px;padding-top: 5px;"><b>服务信息</b> 该部分为公共编辑信息，每个添加了该门店的商户均可提交修改意见，并在审核后选择性采纳</p>
			</div>
			<table cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					    ...
					    <input id="titleLogo" name="titleLogo" type="hidden" nullmsg="请添加图片" value="${weixinLocationPage.titleLogo}" datatype="*">
					    <span id="imgName"></span> 
						<span class="Validform_checktip">必须，像素要求必须为640*340像素，支持.jpg .jpeg .bmp .png格式，大小不超过2M</span>
				...
				<tr>
					...
					<td class="value">
					     	<input id="telephone" name="telephone" type="text" style="width: 300px" class="inputxt"  
								               ...
								               value='${weixinLocationPage.telephone}' datatype="*">
							<span class="Validform_checktip">必填，格式如, 020-88888888</span>
							<label class="Validform_label" style="display: none;">门店电话</label>
						</td>
				</tr>
				<tr>
					<td align="right">
					...
					<td class="value">
					     	 <input id="avgPrice" name="avgPrice" type="text" style="width: 300px" class="inputxt"  
								               
								               value='${weixinLocationPage.avgPrice}' datatype="n" datatype="*">
							<span class="Validform_checktip">必填，大于零的整数，须如实填写，默认单位为人民币</span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="openTime" name="openTime" type="text" style="width: 300px" class="inputxt"  
								               
								               value='${weixinLocationPage.openTime}' datatype="*">
							<span class="Validform_checktip">必填，格式如，10:00-21:00</span>
				...
				<tr>
					...
					<td class="value">
						<input id="special" name="special" type="text" style="width: 300px" class="inputxt"  
								               value='${weixinLocationPage.special}' datatype="*">
								               
							
							<span class="Validform_checktip">必填，如：免费停车，免费wifi，送货上门</span>
							<label class="Validform_label" style="display: none;">特色服务</label>
				...
				<tr>
					...
					<td class="value">
							 <input id="recommend" name="recommend" type="text" style="width: 300px" class="inputxt"  
								               value='${weixinLocationPage.recommend}'>

							<span class="Validform_checktip">选填，如，推荐菜，推荐景点，推荐房间</span>
							<label class="Validform_label" style="display: none;">新品推荐</label>
						</td>
				</tr>
				...
				<tr>
					...
					<td class="value">
							<textarea name="introduction" id="introduction" style="width:300px;height:100px">${weixinLocationPage.introduction}</textarea>
							<span class="Validform_checktip">选填，对品牌或门店的简要介绍</span>
