 ...
 <div class="main_bd">
  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="weixinLocationController.do?doAdd" tiptype="1" beforeSubmit="toValidateForm">
		...
		<div style="border: solid #f7cc8f 1px;background: #FFEFCE;margin:10px 1px 10px 1px;;vertical-align: middle;height: 30px;" id="point_title">
			 	<p style="padding-left: 15px;height: 30px;vertical-align: middle;padding-top: 5px;"><b>基本信息</b> 基本信息提交后不可修改</p>
		</div>
		<table cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="businessName" name="businessName" type="text" style="width: 300px" class="inputxt"  
								               
								              value="${weixinLocationPage.businessName}" datatype="*" maxlength="30">
							<span class="Validform_checktip">必填，仅为商户名，如：麦当劳，不包含地区、地址</span>
							<label class="Validform_label" style="display: none;">门店名</label>
						</td>
				</tr>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="branchName" name="branchName" type="text" style="width: 300px" class="inputxt"  
								               
								              datatype="*">
							<span class="Validform_checktip">必填，不应与门店名有重复，不包含地区、地址</span>
							<label class="Validform_label" style="display: none;">分店名</label>
						</td>
				</tr>
				<tr>
					<td align="right">
					...
					<td class="value">
					     	...
					     	<select id="CategorySelect1" name="CategorySelect1"></select>
							<select id="CategorySelect2" name="CategorySelect2"></select>

							<script type="text/javascript">								
								locationCategoryInit('CategorySelect1', 'CategorySelect2');
							</script>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="address" name="address" type="text" style="width: 300px" class="inputxt"  
								               ...
								               value='${weixinLocationPage.address}' datatype="*">
							<span class="Validform_checktip">必填</span>
				...
				<tr>
					...
					<td class="value">
							...
							<span class="Validform_checktip">必填，门店所在地理位置</span>
							<label class="Validform_label" style="display: none;">坐标定位</label>
						</td>
				</tr>
				<tr>
					<td>
					...
					<p>给地图绑定了点击事件，当点击地图时，会自动获取点击点的坐标经纬度。</p>
