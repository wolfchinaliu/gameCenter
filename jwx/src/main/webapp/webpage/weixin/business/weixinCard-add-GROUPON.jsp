			...
			<div class="appmsg_editor" style="margin-top: 0px;">
				<div class="inner" style="width: 800px;">
					...
					<t:formvalid formid="formobj" dialog="true" usePlugin="password"
						...
						<input id="cardType" name="cardType" type="hidden" value="GROUPON">
						<table cellpadding="0" cellspacing="1" class="formtable">

							<c:if test="${empty weixinCardPage.id}">
								<tr>
									<td align="right" height="35px" width="100px"><label
										class="Validform_label"> 团购券LOGO: </label></td>
									<td class="value"><span
							...
							<tr>
								<td align="right"><label class="Validform_label">
										团购详情: </label></td>
								<td class="value"><input id="dealDetail" name="dealDetail"
									type="text" style="width: 200px" class="inputxt"
									value="${weixinCardPage.dealDetail}" datatype="*"> <span
									class="Validform_checktip"></span> <label
									class="Validform_label" style="display: none;">优惠详情</label></td>
