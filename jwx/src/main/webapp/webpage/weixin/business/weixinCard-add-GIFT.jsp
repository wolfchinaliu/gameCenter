			...
			<div class="appmsg editing">
				<div class="appmsg_content" id="js_appmsg_preview">
					...
					<div id="files" class="files">
						<i class="appmsg_thumb default" id="imageShow">礼品券LOGO</i>
					</div>
			...
			<div class="appmsg_editor" style="margin-top: 0px;">
				<div class="inner" style="width: 800px;">
					...
					<t:formvalid formid="formobj" dialog="true" usePlugin="password"
						...
						<input id="cardType" name="cardType" type="hidden" value="GIFT">
						<table cellpadding="0" cellspacing="1" class="formtable">

							<c:if test="${empty weixinCardPage.id}">
								<tr>
									<td align="right" height="35px" width="100px"><label
										class="Validform_label"> 礼品券LOGO: </label></td>
									<td class="value"><span
							...
							<tr>
								<td align="right"><label class="Validform_label">
										礼品名称: </label></td>
								<td class="value"><input id="gift" name="gift" type="text"
									style="width: 200px" class="inputxt"
									value="${weixinCardPage.gift}" datatype="*"> <span
									class="Validform_checktip"></span> <label
									class="Validform_label" style="display: none;">礼品名称</label></td>
