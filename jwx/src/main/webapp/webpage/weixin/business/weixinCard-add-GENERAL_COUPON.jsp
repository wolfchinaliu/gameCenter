...
<html>
 <head>
  ...
  $(function () {
      ...
      if(logoUrl != ""){
          $("#imageShow").html('<img src="${weixinCardPage.logoUrl}" width="100%" height="160" />');
      }
  });
 ...
 <div class="main_bd">
		<div class="media_preview_area">
			<div class="appmsg editing">
				<div class="appmsg_content" id="js_appmsg_preview">
						...
						<div id="files" class="files">
							<i class="appmsg_thumb default" id="imageShow">优惠券LOGO</i>
						</div>
 		...
 		<div class="media_edit_area" id="js_appmsg_editor" style="background: white;width: 800px;">	
			<div class="appmsg_editor" style="margin-top: 0px;width: 800px;">
		 		<div class="inner" style="width: 800px;">
		 		
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="weixinCardController.do?doAdd" tiptype="1">
					<input id="id" name="id" type="hidden" value="${weixinCardPage.id }">
					<input id="createName" name="createName" type="hidden" value="${weixinCardPage.createName }">
					<input id="createDate" name="createDate" type="hidden" value="${weixinCardPage.createDate }">
					<input id="accountid" name="accountid" type="hidden" value="${weixinCardPage.accountid }">
					
					<input id="cardType" name="cardType" type="hidden" value="GENERAL_COUPON">
		<table cellpadding="0" cellspacing="1" class="formtable" style="width: 800px;">
		
				<c:if test="${empty weixinCardPage.id}">
				<tr>
					<td align="right" height="35px" width="100px">
					...
					<td class="value">
							    ...
							    <input id="logoUrl" name="logoUrl" type="hidden" nullmsg="请添加图片" value="${weixinCardPage.logoUrl}" datatype="*">
				...
				<tr>
					...
					<td class="value">
					     	 <input id="brandName" name="brandName" type="text" style="width: 200px" class="inputxt"  
								               
								                value="${weixinCardPage.brandName}" datatype="*">
							<span class="Validform_checktip">字数上限为12个汉字</span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="title" name="title" type="text" style="width: 200px" class="inputxt"  
								               
								               value="${weixinCardPage.title}" datatype="*">
							<span class="Validform_checktip">字数上限为9个汉字</span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="subTitle" name="subTitle" type="text" style="width: 200px" class="inputxt"  
								               
								               value="${weixinCardPage.subTitle}" >
							<span class="Validform_checktip">字数上限为18个汉字</span>
							<label class="Validform_label" style="display: none;">券名的副标题</label>
						</td>
					</tr>
				<tr>
					<td align="right">
					...
					<td class="value">
							...
							<label class="Validform_label" style="display: none;">券颜色</label>
						</td>
				</tr>
				<tr>
					<td align="right">
					...
					<td class="value">
					     	 <input id="notice" name="notice" type="text" style="width: 200px" class="inputxt"  
								               
								               value="${weixinCardPage.notice}" datatype="*">
							<span class="Validform_checktip">如：节假日不可用，字数上限为16个汉字</span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="description" name="description" type="text" style="width: 200px" class="inputxt"  
								                ...
								                value="${weixinCardPage.description}" datatype="*">
							<span class="Validform_checktip">如：消费时向服务员出示该券，字数上限为1024个汉字</span>
				...
				<c:if test="${not empty weixinCardPage.id}">
					...
					<td class="value">
						<input name="businame" type="text" style="width: 200px" class="inputxt" value="${weixinCardPage.businessName }" id="businame">
					</td>
					</tr>
				</c:if>
				<tr>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="default_detail" name="default_detail" type="text" style="width: 200px" class="inputxt"  
								               
								               value="${weixinCardPage.default_detail}" datatype="*">
							<span class="Validform_checktip"></span>
							<label class="Validform_label" style="display: none;">优惠详情</label>
						</td>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="servicePhone" name="servicePhone" type="text" style="width: 200px" class="inputxt"  
								               
								               value="${weixinCardPage.servicePhone}">
							<span class="Validform_checktip">格式如：020-88888888</span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="quantity" name="quantity" type="text" style="width: 200px" class="inputxt"  
								               
								               value="${weixinCardPage.quantity}" datatype="/^[0-9]+$/" datatype="n">
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="getLimit" name="getLimit" type="text" style="width: 200px" class="inputxt"  
								               
								               value="${weixinCardPage.getLimit}" datatype="/^[0-9]+$/" datatype="n">
							<span class="Validform_checktip">填写大于0的整数</span>
							<label class="Validform_label" style="display: none;">每人限领数量</label>
						</td>
					</tr>
				<%-- 
				<tr>
