...
@Scope("prototype")
@Controller
@RequestMapping("/crmLoginController")
public class CrmLoginController extends BaseController {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(CrmLoginController.class);
	...
	public ModelAndView login(HttpServletRequest request) {
		...
		return new ModelAndView("crm/login");
	}
	...
	public ModelAndView index(HttpServletRequest request) {
		...
		return new ModelAndView("crm/index");
	}
	 ...
	 * @return
	 */
	@RequestMapping(params = "style")
	public ModelAndView style(HttpServletRequest request) {

		return new ModelAndView("crm/style");
	}
	...
	public ModelAndView userinfo(HttpServletRequest request) {
		...
		return new ModelAndView("crm/userinfo");
	}
	...
	public ModelAndView updatepass(HttpServletRequest request) {
		...
		return new ModelAndView("crm/updatepass");
	}
	...
	public ModelAndView register(HttpServletRequest request) {
		...
		return new ModelAndView("crm/register");
	}
}
