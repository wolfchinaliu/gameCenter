 ...
 */
@Controller
@RequestMapping("/guanggaoController")
public class AdController extends BaseController {
	 ...
	 * @return
	 */
	@RequestMapping(params = "guanggao")
	public ModelAndView guanggao(HttpServletRequest request) {
		return new ModelAndView("weixin/cms/guanggaoList");
	}
	...
	public ModelAndView toUpdate(AdEntity adE, HttpServletRequest req) {
		if (StringUtil.isNotEmpty(adE.getId())) {
			adE = adService.getEntity(AdEntity.class, adE.getId());
			req.setAttribute("adPage", adE);
		}
		return new ModelAndView("weixin/cms/guanggao");
	}
}
