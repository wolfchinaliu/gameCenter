...
//
//	@Autowired
//	HuodongServiceI huodongService;
//
...
//
//		///
//		HuodongEntity huodongEntity = huodongService.get(HuodongEntity.class, hdIdObj.toString());
//
//		String accountid = huodongEntity.getAccountid();
//
//
//		//findAccountId(request);
//		String prize = "";
//		String hdId = "";
//		String opendId = "";
//		if(prizeObj!=null){
...
//
//		HuodongEntity huodongEntity = huodongService.get(HuodongEntity.class, hdId);
//
//		String accountid = huodongEntity.getAccountid();
//		//String accountid = findAccountId(request);
//
...
//		HuodongEntity huodongEntity = huodongService.get(HuodongEntity.class, hdIdObj.toString());
//
//		accountid = huodongEntity.getAccountid();
//				//findAccountId(request);
//		if(hdIdObj!=null){
//			hdId = hdIdObj.toString();
//		}
