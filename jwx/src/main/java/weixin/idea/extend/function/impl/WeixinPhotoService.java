...
//		}
		...
		article.setPicUrl(ResourceUtil.getDomain()+ "/template/photo/default/images/albums_head.jpg");
		// 此userid后期需要通过高级接口获取到微信帐号，此处先以加密后的ID为参数进行传递
		article.setUrl(ResourceUtil.getDomain()+ "/cmsController.do?goPage&page=photoAlbum&accountid="+ accountid + "&userid="
