...
public class GZipFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if(isGZipEncoding(req)){
            ...
            try {
                ...
                System.out.println("GZipFilter.doFilter error:" + e.getMessage());
            }
        } else {
    ...
    public void CacheResource(ServletRequest request, ServletResponse response,
        ...
        org.jeecgframework.core.util.LogUtil.info( uri );//测试获取后缀是否正确   
        //4断相应后缀文件，设定缓存时间   
        long date = 0;  
        //org.jeecgframework.core.util.LogUtil.info( new Date().getTime());//测试当前时间用   
