...
public class TerritoryController extends BaseController {
	...
	@RequestMapping(params="test")
		 public ModelAndView test(TSTerritory territory, HttpServletRequest req){

		territory = systemService.getEntity(TSTerritory.class, "33");
		req.setAttribute("territory",territory);
		return new ModelAndView("system/territory/testcurd");
	}
	@RequestMapping(params="test")
	public ModelAndView testc(TSTerritory territory, HttpServletRequest req){
