...
<div class="easyui-layout" fit="true" style="border: 0px;">
  ...
  <t:datagrid name="weixinSourceList" checkbox="true" fitColumns="false" title="素材管理" actionUrl="weixinSourceController.do?datagrid&type=voice" idField="id" fit="true" queryMode="group">
