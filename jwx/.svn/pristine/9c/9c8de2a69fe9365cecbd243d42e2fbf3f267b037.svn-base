...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="weixinShopFavoriteController.do?doUpdate" tiptype="1">
					<input id="id" name="id" type="hidden" value="${weixinShopFavoritePage.id }">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="openId" name="openId" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
									                 value='${weixinShopFavoritePage.openId}'>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="goodsId" name="goodsId" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
									                 value='${weixinShopFavoritePage.goodsId}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="createDate" name="createDate" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${weixinShopFavoritePage.createDate}'>
							<span class="Validform_checktip"></span>
  ...
  <script src = "webpage/weixin/shop/weixinShopFavorite.js"></script>		