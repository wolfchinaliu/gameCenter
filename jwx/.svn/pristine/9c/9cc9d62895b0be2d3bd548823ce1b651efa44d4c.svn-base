...
public class CommonServiceImpl implements CommonService {
	...
	public <T> List<T> findHqlWithKeyParam(String hql, Map<String, Object> param) {
	    return this.commonDao.findHqlWithKeyParam(hql, param);
	}
	...
	public <T> List<T> findByHqlLimit(int start,int size,String hql ,Object... param){
		return this.commonDao.findHqlLimit(start, size, hql, param);
	}
