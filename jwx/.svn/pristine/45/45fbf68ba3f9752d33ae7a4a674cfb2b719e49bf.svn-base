...
public class CustomController extends BaseController {
	 ...
	 * @return
	 */
	@RequestMapping(params = "customlist")
	public ModelAndView customlist(HttpServletRequest request) {

		return new ModelAndView("crm/customlist");
	}
	 ...
	 * @return
	 */
	@RequestMapping(params = "addCustom")
	public ModelAndView addCustom(HttpServletRequest request) {

		return new ModelAndView("crm/custom-add");
	}
	 ...
	 * @return
	 */
	@RequestMapping(params = "contactlist")
	public ModelAndView contactlist(HttpServletRequest request) {

		return new ModelAndView("crm/contactlist");
	}
	 ...
	 * @return
	 */
	@RequestMapping(params = "addContact")
	public ModelAndView addContact(HttpServletRequest request) {

		return new ModelAndView("crm/contact-add");
	}
}
