...
/**
 * Created by xiaona on 2016/3/9. 流量赠送汇总
 */
public class AllFlowCollect implements java.io.Serializable {
	...
	private java.lang.String hdType; // reason
	// private java.util.Date gettime;

	@Excel(exportName = "累计成功赠送(M)")
