...
<html>
 ...
 <div class="main_bd">
  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="weixinMemberCardController.do?doAdd" tiptype="1">
		...
		<table cellpadding="0" style="width:600px" cellspacing="1" class="formtable">
				<tr>
				...
				<tr>
					...
					<td class="value">
							...
							<span class="Validform_checktip">(必填，如：白金卡)字数上限为9个汉字</span>
				...
				<tr>
					...
					<td class="value">
							...
							<span class="Validform_checktip">(可不填)</span>
				...
				<tr>
					...
					<td class="value">
							...
							<span class="Validform_checktip">(必填，如：持白金会员卡到店消费，可享8折优惠)</span>
				...
				<tr>
					...
					<td class="value">
							<select id="supplyBalance" name="supplyBalance">
								<option value="true">是</option>
								<option value="false">否</option>
							</select>
					     	
							<span class="Validform_checktip"></span>
							<label class="Validform_label" style="display: none;">支持储值</label>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="value">
							...
							<span class="Validform_checktip">(必填，如：使用时向服务员出示二维码)字数上限为16个汉字</span>
				...
				<tr>
					...
					<td class="value">
							...
							<span class="Validform_checktip">(必填，如：不可与其他优惠同享)</span>
				...
				<tr>
					...
					<td class="value">
							...
							<span class="Validform_checktip">(可不填)格式如：020-88888888</span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="getLimit" name="getLimit" type="text" style="width: 100px" class="inputxt"  
