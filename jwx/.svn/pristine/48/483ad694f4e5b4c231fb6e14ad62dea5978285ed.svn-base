		...
		<table cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
							    ...
							    <input id="logoUrl" name="logoUrl" type="hidden" nullmsg="请添加图片" value="${weixinCardPage.logoUrl}">
				...
				<tr>
					...
					<td class="value">
					     	 <input id="codeType" name="codeType" type="text" style="width: 200px" class="inputxt"  
								               
								               value="${weixinCardPage.codeType}">
							<span class="Validform_checktip"></span>
							<label class="Validform_label" style="display: none;">码展示类型</label>
						</td>
				</tr>
				<tr>
					<td align="right">
					...
					<td class="value">
					     	 <input id="brandName" name="brandName" type="text" style="width: 200px" class="inputxt"  
								                ...
								                value="${weixinCardPage.brandName}">
				...
				<tr>
					...
					<td class="value">
					     	 <input id="color" name="color" type="text" style="width: 200px" class="inputxt"  
								               
								               value="${weixinCardPage.color}">
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="notice" name="notice" type="text" style="width: 200px" class="inputxt"  
								               ...
								               value="${weixinCardPage.notice}">
							<span class="Validform_checktip">字数上限为16个汉字</span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="description" name="description" type="text" style="width: 200px" class="inputxt"  
								                ...
								                value="${weixinCardPage.description}">
							<span class="Validform_checktip">字数上限为1024个汉字</span>
				...
				<tr>
					...
					<td class="value">
							...
							<input name="locationIdList" name="locationIdList" type="hidden" value="${id}" id="locationIdList"> 
							<input name="businessName" class="inputxt" value="${businessName }" id="businessName" readonly="readonly" datatype="*" /> 
							<t:choose hiddenName="locationIdList" hiddenid="id" url="weixinLocationController.do?locations" name="locationList" icon="icon-search" title="门店列表" textname="businessName" isclear="true"></t:choose>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="beginTimestamp" name="beginTimestamp" type="text" style="width: 200px" class="inputxt"  
								               
								               value="${weixinCardPage.beginTimestamp}">
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="endTimestamp" name="endTimestamp" type="text" style="width: 200px" class="inputxt"  
								               
								               value="${weixinCardPage.endTimestamp}">
							<span class="Validform_checktip"></span>
