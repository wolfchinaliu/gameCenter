        ...
        <div class="appmsg editing">
            <div class="appmsg_content" id="js_appmsg_preview">
                ...
                <div id="files" class="files">
                    <i class="appmsg_thumb default">图片未上传</i>
                </div>
    ...
    <div class="media_edit_area" id="js_appmsg_editor">
        <div class="appmsg_editor" style="margin-top: 0px;">
            <div class="inner">
                ...
                <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="weixinSourceController.do?doAdd" tiptype="1">
                    <%--<input id="id" name="id" value="${weixinArticlePage.id }">--%>
                    <%--<input id="templateId" name="templateId" value="${templateId}">--%>
                    <%--<input id="createDate" name="createDate" value="${weixinArticlePage.createDate }">--%>
                        ...
                        <%--<tr>--%>
                            ...
                            <%--<td class="value">--%>
                                <%--<t:dictSelect field="sourceType" type="list"--%>
                                              <%--typeGroupCode="sourcetype" defaultVal="${weixinSourcePage.sourceType}" hasLabel="false"--%>
                                              <%--title="素材类型"></t:dictSelect>--%>
                                <%--<span class="Validform_checktip"></span>--%>
...
<%--<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="weixinSourceController.do?doAdd"--%>
             <%--tiptype="1">--%>
    ...
    <%--<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">--%>
        ...
        <%--<tr>--%>
            ...
            <%--</td>--%>
            <%--<td class="value">--%>
                <%--<input id="fileurl" name="fileurl" type="file" style="width: 150px" class="inputxt"/>--%>
                <%--<span class="Validform_checktip">请选择需要上传的文件</span>--%>
