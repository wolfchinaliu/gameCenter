...
public class TemplateMessage {
	...
	private TemplateData createDate;
	
	private TemplateData ProcessingResults;
	...
	public TemplateData getCreateDate() {
		return createDate;
	}

	public void setCreateDate(TemplateData createDate) {
		this.createDate = createDate;
	}

	public TemplateData getProcessingResults() {
		return ProcessingResults;
	}

	public void setProcessingResults(TemplateData processingResults) {
