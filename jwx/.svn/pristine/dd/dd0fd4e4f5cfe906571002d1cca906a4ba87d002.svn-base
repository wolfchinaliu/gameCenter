...
<html>
 ...
 <div class="appmsg editing">
				<div class="appmsg_content" id="js_appmsg_preview">
						...
						<div id="files" class="files">
							<i class="appmsg_thumb default" id="imageShow">官网logo</i>
						</div>
  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="weixinCmsSiteController.do?doUpdate" tiptype="1">
					...
					<input id="siteTemplateStyle" name="siteTemplateStyle" type="hidden" value="${weixinCmsSitePage.siteTemplateStyle }">
		...
		<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
						...
						<a href="<%=basePath%>/cmsController.do?goPage&page=index&accountid=${weixinCmsSitePage.accountid}" title="点击新窗口中打开" target="_blank"><%=basePath%>/cmsController.do?goPage&page=index&accountid=${weixinCmsSitePage.accountid}
						</a>
						<%-- <input type="hidden" id="linkUrl" value="<%=basePath%>/cmsController.do?goPage&page=index&accountid=${weixinCmsSitePage.accountid}"/>
						<input type="button" value="复制" onclick="jsCopy()" class="l-btn">--%>
					</td>
				</tr>
				<tr>
					...
					<td class="value">
					     	 <input id="siteName" name="siteName" value="${weixinCmsSitePage.siteName}"  type="text" style="width: 300px" class="inputxt"  >
							<span class="Validform_checktip"></span>
							<label class="Validform_label" style="display: none;">官网名称</label>
					</td>
				</tr>
				<tr>
					<td align="right">
					...
					<td class="value">
					     	 <input id="companyTel" name="companyTel" type="text" value="${weixinCmsSitePage.companyTel}" style="width: 300px" class="inputxt" >
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
							...
							<span class="Validform_checktip"></span>
							<label class="Validform_label" style="display: none;">官网logo</label>
					</td>
				</tr>
 ...
 <script type="text/javascript"> 
    function jsCopy(){
		...
		var e=document.getElementById("linkUrl");
