...
<html>
 ...
 <div id="point_title" style="border: solid #f7cc8f 1px;background: #FFEFCE;margin-bottom: 5px;margin-top: 5px;">
 	<p style="padding-left: 15px;">提示：通过认证的订阅号或者服务号才能使用自定义菜单,自定义菜单目前限制只能3个一级菜单，5个二级菜单。</p>
 	<p style="padding-left: 50px;">当您为自定义菜单填写网页链接地址时请填写以"http://"开头，这样可以保证用户手机浏览的兼容性更好。
 	</p>
 </div>
</c:if>
