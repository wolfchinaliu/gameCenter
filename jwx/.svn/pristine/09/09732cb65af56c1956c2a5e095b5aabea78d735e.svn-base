...
<div region="center" style="padding: 1px;"><t:datagrid name="cgformFtlList" title="表单模板列表" actionUrl="cgformFtlController.do?datagrid&cgformId=${formid}" idField="id" fit="true">
	...
	<t:dgConfOpt title="激活" message="确认激活模板" exp="ftlStatus#eq#0" url="cgformFtlController.do?active&id={id}&formId=${formid}" />
	<t:dgConfOpt title="取消激活" message="确认取消激活" exp="ftlStatus#eq#1" url="cgformFtlController.do?cancleActive&id={id}&formId=${formid}" />
