...
@Scope("prototype")
@Controller
@RequestMapping("/shareController1")
public class ShareController1 {
	private static final Logger LOGGER = Logger.getLogger(ShareController1.class);
    ...
    public ModelAndView setShare(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            buffer.append("shareController1_setShare_begin:_");
...
//        String url = "http://localhost:8080/jwx/share/QueryActicle";
    ...
    public AjaxJson doUpdate(ShareItem shareItem, HttpServletRequest request) throws BusinessException {
        ...
        long startTime = System.currentTimeMillis();
        StringBuffer buffer = new StringBuffer();
        buffer.append("shareController1_setShare_doUpdate_begin:_");
        try {
...
//            shareItem.setId(id);
    ...
    /**
     * http://weixina.1shiliu.com/jwx/shareController1.do?startLoad&accountid=ea84c08653c7aeb30153cbb2288f06d8&shareId=ea84c086555e5224015561c7d2dc0e84
     * 用户自己点击链接进入分享流量页面
     *
     * @param request
     * @param response
    ...
    private String pageAuth(Map<String, String> properties) {
        ...
        if ("0".equals(shiliuAccount.getAuthorizationType())) {
            ...
            String url = CommonUtils.encodeURL(ResourceUtil.getConfigByName("domain") + "/shareController1.do?showSharePage");
    ...
    public ModelAndView showSharePage(HttpServletRequest request) throws Exception {
        CommonUtils.printRequestParam("shareController1.showSharePage", request);
        long startTime = System.currentTimeMillis();//获取开始当前的时间
        StringBuffer buffer = new StringBuffer();
        buffer.append("shareController1_showSharePage_begin_");
        ...
        try {
            ...
            if (StringUtils.isBlank(type1)) {
                ...
                if (StringUtils.isBlank(appid)) {
                    LOGGER.info("shareController1_showSharePage普通1公众号网页授权");
                } else {
                    LOGGER.info("shareController1_showSharePage第三3方平台网页授权");
                    authType = 1;
                }
            ...
            if (shareItem != null) {
                ...
                URIBuilder builder = new URIBuilder("shareController1.do?forwardShare");
                ...
                if (memberEntity == null || memberEntity.getSubscribe().equals("0")) {
                    ...
                    buffer.append("_noSub_").append("shareController1_showSharePage_end_time:" + (endTime - startTime) + "ms");
                    LOGGER.info(buffer.toString());
                    ...
                    if (StringUtils.isBlank(memberEntity.getPhoneNumber())) {
                        // 没有绑定，跳到点击按钮弹出绑定的页面
                        long endTime = System.currentTimeMillis();//获取结束的当前时间
                        buffer.append("_noBinding_").append("shareController1_showSharePage_end_time:" + (endTime - startTime) + "ms");
                        LOGGER.info(buffer.toString());
                        return new ModelAndView("redirect:" + forwardUrl);
                    } else {
                        // 绑定了，跳到只有一个按钮的页面，允许分享
                        long endTime = System.currentTimeMillis();//获取结束的当前时间
                        buffer.append("_share_").append("shareController1_showSharePage_end_time:" + (endTime - startTime) + "ms");
                        LOGGER.info(buffer.toString());
                        return new ModelAndView("redirect:" + forwardUrl);
                    }
                }
                ...
                long endTime = System.currentTimeMillis();
                buffer.append("_noShare_").append("shareController1_showSharePage_end_time:" + (endTime - startTime) + "ms");
                LOGGER.info(buffer.toString());
    ...
    public ModelAndView forwardSharePage(HttpServletRequest request) throws Exception {
        CommonUtils.printRequestParam("shareController1.forwardSharePage", request);
    ...
    /**
     * 查看人点击分享的链接时, 调用此接口
     * http://weixina.1shiliu.com/jwx/shareController1.do?load
    ...
    public ModelAndView load(HttpServletRequest request, HttpServletResponse response) throws Exception {
        CommonUtils.printRequestParam("shareController1.load", request);
        String shareId = request.getParameter("shareId");
        try {
    ...
    public Map<String, String> generateShareLink(HttpServletRequest requesturl, String accountid, String imgPath, String shareId, String shiliuOpenId) throws Exception {
        ...
        url = url + "?" + param;
        String url2 = domain + "/" + "shareController1.do?load&accountid=" + accountid + "&sharerOpenId=" + shiliuOpenId + "&shareId=" + shareId;
