...
//        panelHeight: '150',
        ...
        onSelect: function () {
          ...
          if(jumptypevalue=="flowpage"){
            ...
            $.ajax({
              type: "POST",
              url: 'weixinUrlController.do?weixinUrlFlow&flag=1',
              cache: false,
              async: true,
              dataType: "json",
      ...
      $('#pagetype').combobox({
        ...
        itemIndex:0,
        onSelect: function () {
          var flowText = $('#pagetype').combobox('getText');
          if (flowText == "分享送流量") {
            document.getElementById("shareurl").style.display = "block";
            $.ajax({
              type: "POST",
              url: 'shareController.do?shareContent',
              cache: false,
              async: true,
              dataType: "json",
              success: function (data) {
                $("#shareTitle").combobox("loadData", data);
                return;
              }
            });
            return
            ...
            document.getElementById("shareurl").style.display = "none";
            $("#shareTitle").removeAttr("datatype");
            return ;
          }
        }
      });
      ...
      switch (jump){
        ...
        var share=$("#shareTitle").combobox("getText");
        if(share==""||share==null){
          document.getElementById("shareurl").style.display="none";
        }else{
          document.getElementById("shareurl").style.display="block";
...
<input id="setType" type="text" value="${weixin.jumptype}">
      ...
      <div class="appmsg_content" id="js_appmsg_preview">
        <h4 class="appmsg_title">
          <a target="_blank" href="javascript:void(0);"
             onclick="return false;">${weixin.title}</a>
        </h4>
        ...
        <div id="files" class="files">
          <i style="height:160px;overflow:hidden;display:inline-block;width:100%;"><img
                  src="${weixin.imagepath}" width="100%" height="160"/></i>
        </div>
    ...
    <div class="appmsg_editor" style="margin-top: 0px;">
      <div class="inner">
        <t:formvalid formid="formobjNew" dialog="true" usePlugin="password" layout="table"
                     action="weixinMainController.do?doUpdate" tiptype="1">
          <input type="hidden" value="${weixin.id}" id="id" name="id">
          <table style="width: 450px;" cellpadding="0" cellspacing="1" class="formtable">
            <tr>
              ...
              <td class="value">
                <input id="title" name="title" type="text" value="${weixin.title}"
            ...
            <tr>
              ...
              <td class="value">
								<span class="btn btn-success fileinput-button">
							        ...
							        <input id="imagepath" name=imagepath type="hidden" value="${weixin.imagepath}"
            ...
            <tr>
              ...
              <td class="value">
                <input id="jumptype" name="jumptype" value="${weixin.jumptype}" type="text" style="width: 300px"
                       class="inputxt">
          ...
          <table style="width: 500px;" cellpadding="0" cellspacing="1" class="formtable">
            ...
            <tr  id="defaulteditor" style="display:none;">
              ...
              <td class="value">
                <textarea name="content" id="content" >${weixin.content}</textarea>
                <script type="text/javascript">
            ...
            <tr id="innerurl" style="display:none;">
              ...
              <td class="value" >
                ...
                <input id="pagetype" name="pagetype" style="width:300px"	class="easyui-combobox" value="${pagetype}">
              ...
              <%--</td>--%>
              <%--<td class="value">--%>
                <%--<input id="pagetype" name="pagetype" value="${pagetype}" type="text" style="width: 300px"--%>
                       <%--class="inputxt">--%>
                  <%--&lt;%&ndash;<input  style="width: 300px" class="easyui-combobox" id="pagetype" name="pagetype" value="${shareItem.pagetype}">&ndash;%&gt;--%>
                <%--<span class="Validform_checktip"></span>--%>
                <%--<label class="Validform_label" style="display: none;">页面类型</label>--%>
              </td>
            </tr>
            <tr id="outurl" style="display:none;">
              ...
              <td class="value">
                <input id="pageurl" name="pageurl" value="${weixin.pageurl}" type="text" style="width: 300px"
            ...
            <tr id="shareurl" style="display:none;">
              <td align="right" style="width:60px">
                <label class="Validform_label">
                  分享页面:
                </label>
              ...
              <td class="value">
                  <%--<input id="pageurl" class="inputxt" name="pageurl" value="${pageurl}" datatype="*" nullmsg="页面类型不能为空！">--%>
                <input id="shareTitle" name="shareTitle" style="width:300px"	class="easyui-combobox" value="${weixin.shareTitle}">
                <%--<span class="Validform_checktip">请选择分享页面</span>--%>
                  <%--<label class="Validform_label" style="display: none;">页面类型</label>--%>
              </td>
              ...
              <%--</td>--%>
              <%--<td class="value">--%>
                <%--<input id="shareTitle" name="shareTitle" value="${weixin.shareTitle}" type="text" style="width: 300px"--%>
                       <%--class="inputxt">--%>
                  <%--&lt;%&ndash;<input style="width: 300px" class="easyui-textbox" id="pageurl" name="pageurl" value="${shareItem.pageurl}">&ndash;%&gt;--%>
                <%--<span class="Validform_checktip"></span>--%>
                <%--<label class="Validform_label" style="display: none;">分享页面</label>--%>
              <%--</td>--%>
            </tr>
            </tbody>
          </table>
