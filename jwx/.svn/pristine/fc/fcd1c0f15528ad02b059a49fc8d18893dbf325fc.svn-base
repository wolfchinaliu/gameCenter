    ...
    <div class="media_preview_area">
        <div class="appmsg editing">
            <div class="appmsg_content" id="js_appmsg_preview">
                ...
                src="${imagepath}" width="100%" height="160"/></i>
                </div>
        ...
        <div class="appmsg_editor" style="margin-top: 0px;">
            <div class="inner">
                <t:formvalid formid="messagefrom" dialog="true" usePlugin="password" layout="table"
                             action="shareController.do?doUpdate" >
                    <input id="id" name="id" hidden="hidden" value="${shareItem.id}">
                        ...
                        <tr>
                            ...
                            <td class="value">
								<span class="btn btn-success fileinput-button">
							        ...
							        <input id="imagepath" name=imagepath type="hidden" value="${imagepath}"
