 ...
 */
@Entity
@Table(name = "weixin_announcement", schema = "")
@SuppressWarnings("serial")
public class WeixinAnnouncementEntity implements java.io.Serializable {
	/**主键*/
