...
public class CmsService implements KeyServiceI {
	...
	public String excute(String content, TextMessageResp defaultMessage,
		...
		article.setPicUrl(ResourceUtil.getDomain()+ "/webpage/weixin/cms/images/index.jpg");
		...
		article.setUrl(ResourceUtil.getDomain()+ "/cmsController.do?goPage&page=index&accountid="+ accountid + "&userid="+ defaultMessage.getToUserName());
