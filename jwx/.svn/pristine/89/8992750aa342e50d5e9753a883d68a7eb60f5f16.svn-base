 ...
 */
@Entity
@Table(name = "weixin_food_category", schema = "")
@SuppressWarnings("serial")
public class WeixinFoodCategoryEntity implements java.io.Serializable {
	/**主键*/
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  分类上级ID
	 */
