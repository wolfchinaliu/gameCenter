...
@Service("tFavoMenuService")
@Transactional
public class TFavoMenuServiceImpl extends CommonServiceImpl implements TFavoMenuServiceI {

	
 	public <T> void delete(T entity) {
 		super.delete(entity);
 		//执行删除操作配置的sql增强
		this.doDelSql((TFavoMenuEntity)entity);
 	}
 	
 	public <T> Serializable save(T entity) {
 		Serializable t = super.save(entity);
 		//执行新增操作配置的sql增强
 		this.doAddSql((TFavoMenuEntity)entity);
 		return t;
 	}
 	...
 	public <T> void saveOrUpdate(T entity) {
 		...
 		//执行更新操作配置的sql增强
 		this.doUpdateSql((TFavoMenuEntity)entity);
 	}
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,TFavoMenuEntity t){
