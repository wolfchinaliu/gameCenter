...
<html>
 ...
 <div class="main_bd">
  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="weixinCardController.do?doAdd" tiptype="1">
					...
					<input id="cardType" name="cardType" type="hidden" value="CASH">
		<table cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
					     	 <input id="least_cost" name="least_cost" type="text" style="width: 200px" class="inputxt"  
								               
								               value="${weixinCardPage.least_cost}" datatype="/^[0-9]+(.[0-9]{1,2})?$/" >
							<span class="Validform_checktip"></span>
							<label class="Validform_label" style="display: none;">起用金额（单位为元）</label>
						</td>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="reduce_cost" name="reduce_cost" type="text" style="width: 200px" class="inputxt"  
								               
								               value="${weixinCardPage.reduce_cost}" datatype="/^[0-9]+(.[0-9]{1,2})?$/" >
							<span class="Validform_checktip"></span>
							<label class="Validform_label" style="display: none;">减免金额（单位为元）</label>
						</td>
