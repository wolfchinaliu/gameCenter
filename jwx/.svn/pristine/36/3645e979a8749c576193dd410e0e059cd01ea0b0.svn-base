...
cc.game = {
    ...
    _initConfig: function () {
        ...
        if (document.ccConfig)this.config = b(document.ccConfig); else try {
            ...
            var f, g, h;
            if (d < c.length) {
                if (f = c[d].src)h = /(.*)\//.exec(f)[0], cc.loader.resPath = h, f = cc.path.join(h, "plug-in/activity/js/liujiaoping/project.json");
...
cc._logToWebPage = function (a) {
    if (cc._canvas) {
        ...
        if (!b) {
            ...
            c.borderBottom = "0px solid #cccccc";
...
cc._initDebugSetting = function (a) {
    ...
    if (a !== b.DEBUG_MODE_NONE) {
        var c;
        a > b.DEBUG_MODE_ERROR ? (c = cc._logToWeb.bind(cc), cc.error = function () {
...
var res = {
    Item0_png: hostAddress+"plug-in/activity/images/liujiaoping/"+userImagePath+"0.png",
    Item1_png: hostAddress+"plug-in/activity/images/liujiaoping/"+userImagePath+"1.png",
    Item2_png: hostAddress+"plug-in/activity/images/liujiaoping/"+userImagePath+"2.png",
    Item3_png: hostAddress+"plug-in/activity/images/liujiaoping/"+userImagePath+"3.png",
    Item4_png: hostAddress+"plug-in/activity/images/liujiaoping/"+userImagePath+"4.png",
    Item5_png: hostAddress+"plug-in/activity/images/liujiaoping/"+userImagePath+"5.png",
    Item6_png: hostAddress+"plug-in/activity/images/liujiaoping/"+userImagePath+"6.png",
    Item7_png: hostAddress+"plug-in/activity/images/liujiaoping/"+userImagePath+"7.png",
    ColorBg1_png: hostAddress+"plug-in/activity/images/liujiaoping/bg/1.png",
    ColorBg2_png: hostAddress+"plug-in/activity/images/liujiaoping/bg/2.png",
    ColorBg3_png: hostAddress+"plug-in/activity/images/liujiaoping/bg/3.png",
    ColorBg4_png: hostAddress+"plug-in/activity/images/liujiaoping/bg/4.png",
    ColorBg5_png: hostAddress+"plug-in/activity/images/liujiaoping/bg/5.png",
    ColorBg6_png: hostAddress+"plug-in/activity/images/liujiaoping/bg/6.png",
    ColorBg7_png: hostAddress+"plug-in/activity/images/liujiaoping/bg/7.png",
    Shadow1_png: hostAddress+"plug-in/activity/images/liujiaoping/shadow/1.png",
    Shadow2_png: hostAddress+"plug-in/activity/images/liujiaoping/shadow/2.png",
    Shadow3_png: hostAddress+"plug-in/activity/images/liujiaoping/shadow/3.png",
    Shadow4_png: hostAddress+"plug-in/activity/images/liujiaoping/shadow/4.png",
    Shadow5_png: hostAddress+"plug-in/activity/images/liujiaoping/shadow/5.png",
    Shadow6_png: hostAddress+"plug-in/activity/images/liujiaoping/shadow/6.png",
    Shadow7_png: hostAddress+"plug-in/activity/images/liujiaoping/shadow/7.png",
    Num_png: hostAddress+"plug-in/activity/images/liujiaoping/num.png",
    Circle_png: hostAddress+"plug-in/activity/images/liujiaoping/circle.png",
    Bomb_mp3: hostAddress+"plug-in/activity/images/liujiaoping/music/bomb.mp3",
    Bomb_ogg: hostAddress+"plug-in/activity/images/liujiaoping/music/bomb.ogg",
    Put_mp3: hostAddress+"plug-in/activity/images/liujiaoping/music/put.mp3",
    Put_ogg: hostAddress+"plug-in/activity/images/liujiaoping/music/put.ogg",
    In_mp3: hostAddress+"plug-in/activity/images/liujiaoping/music/in.mp3",
    In_ogg: hostAddress+"plug-in/activity/images/liujiaoping/music/in.ogg",
    GameOver_mp3: hostAddress+"plug-in/activity/images/liujiaoping/music/game_over.mp3",
    GameOver_ogg: hostAddress+"plug-in/activity/images/liujiaoping/music/game_over.ogg",
    IconGame_png: hostAddress+"plug-in/activity/images/liujiaoping/icon_moregame.png",
    IconReplay_png: hostAddress+"plug-in/activity/images/liujiaoping/icon_replay.png",
    IconFacebook_png: hostAddress+"plug-in/activity/images/liujiaoping/icon_facebook.png",
    IconTwitter_png: hostAddress+"plug-in/activity/images/liujiaoping/icon_twitter.png",
    Facebook_png: hostAddress+"plug-in/activity/images/liujiaoping/f_share.png",
    ShareArrow2_png: hostAddress+"plug-in/activity/images/liujiaoping/share_arrow2.png",
    PlayAgain2_png: hostAddress+"plug-in/activity/images/liujiaoping/play_again.png",
    GameOver2_png: hostAddress+"plug-in/activity/images/liujiaoping/game_over2.png",
    GameOver_png: hostAddress+"plug-in/activity/images/liujiaoping/game_over.png",
    ScoreBg_png: hostAddress+"plug-in/activity/images/liujiaoping/score_bg.png",
    JiXuBtn_png: hostAddress+"plug-in/activity/images/liujiaoping/jixuyouxi.png",
    ChouJiangBtn_png: hostAddress+"plug-in/activity/images/liujiaoping/choujianganniu.png",
    Share_png: hostAddress+"plug-in/activity/images/liujiaoping/fenxiangyixia.png",
    fenxiang_png: hostAddress+"plug-in/activity/images/liujiaoping/fenxiang.png",
    fenxiang2_png: hostAddress+"plug-in/activity/images/liujiaoping/fenxiang2.png",
    MoreGame_png: hostAddress+"plug-in/activity/images/liujiaoping/moregame.png"
}, g_resources = [], i;
...
var GameLayer = cc.Layer.extend({
    ...
    initBottomEdgeY: function () {
    	...
    	$('#adDiv').css({'float':'bottom','left':'0px','bottom':'0px','display':'block','position':'absolute','width':'100%' ,'heigth':'80px'}).addClass('zoomInDown');
    	$('#adDiv').height('78px');
    	$('#adimgedis').css({'width':$('.mask').width() ,'heigth':'78px'});
    	$('#adimgedis').height('78px');
        AD_REAL_H = a;
    },
    initSystem: function () {
        var a = cc.sys;
    ...
    initBgCircle: function () {
        ...
        a.y = this.bottomEdgeY + a.height / 2 + 70;
        a.opacity = 180;
    ...
    getItem: function (a) {
        ...
        var b = new cc.Sprite(res["Item"+a+"_png"]);
    ...
    putTile: function () {
        ...
        SoundUtile.playMusic(hostAddress+"plug-in/activity/images/liujiaoping/music/put");
        this.checkCanPop()
    },
    oldLightTiles: null,
    canPutFlag: null,
    ...
    getColorBgItem: function (a) {
        a = new cc.Sprite(hostAddress+"plug-in/activity/images/liujiaoping/bg/"+ a + ".png");
        this.addChild(a, 1);
        a.opacity = 130;
        return a
    },
    ...
    addShadowAnimation: function (a) {
        var b = a.getPosition(), c = a.moveTarget.getPosition(), c = MyUtil.getAngleByPoints(b, c), b = new cc.Sprite(hostAddress+"plug-in/activity/images/liujiaoping/shadow/" + a.colorId + ".png");
        this.addChild(b);
        b.x = a.x;
        b.y = a.y;
        c *= -1;
    ...
    bombStart: function () {
        ...
        function b(a, b) {
            ...
            b == g.bombItem ? (c = cc.sequence(cc.moveBy(c / 6, cc.p(-3, 3)), cc.moveBy(c / 6, cc.p(6, -6)), cc.moveBy(c / 6, cc.p(-6, 0)), cc.moveBy(c / 6, cc.p(6, 6)), cc.moveBy(c / 6, cc.p(-6, -3)), cc.moveBy(c / 6, cc.p(3, 0)), cc.delayTime(0.15)), c = cc.sequence(cc.delayTime(a), c, cc.callFunc(function () {
                SoundUtile.playMusic(hostAddress+"plug-in/activity/images/liujiaoping/music/bomb")
    ...
    addItemPoint: function (a) {
        ...
        SoundUtile.playMusic(hostAddress+"plug-in/activity/images/liujiaoping/music/in");
        if (8 <= b)this.bombItem = a; else {
            ...
            a.setLocalZOrder(1);
            d = new cc.Sprite(res["Item"+c+"_png"]);
            this.addChild(d, 1);
            d.opacity = 0;
            d.x = a.x;
            d.y = a.y;
    ...
    gameEnd: function () {
        ...
        cc.log("gameEnd");
        SoundUtile.playMusic(hostAddress+"plug-in/activity/images/liujiaoping/music/game_over");
		...
		//游戏结束可进行ajax请求 结果回调 gameEndCallBack
        subscore(this.score);
...
var GameInfoLayer = cc.LayerColor.extend({
    ctor: function () {
        ...
        var b, c;
        ChineseFlag ? (b = "\u70b9\u51fb\u4e0b\u9762\u65b9\u5757\u53ef\u8fdb\u884c\u65cb\u8f6c\uff0c\u5c06\u65b9\u5757\u62d6\u5165\u4e0a\u65b9\u7a7a\u767d\u5904\uff0c\u5f53\u5468\u56f4\u8fde\u63a53\u4e2a\u53ca\u4ee5\u4e0a\u540c\u8272\uff08\u540c\u56fe\u6848\uff09\u65f6\uff0c\u53ef\u4ee5\u8fdb\u884c\u6d88\u9664\u5408\u5e76\u3002", c = "\u70b9\u51fb\u5f00\u59cb") : (b = "Click on the following squares can rotate, can be square above into a blank space, when connecting three the same color, can be eliminated to merge.", c = "Start");
...
function subscore(score) {
    ...
    if(is_worng) {score = 0;}else{title = "我在"+activityTitle+"获得 " + score +"分，还能获得海量免费流量，不服来战！"; desc ="我一举拿下 " + score +"分，还能获得免费流量，不服来战！"}
    flag = false;
        $.ajax({
            type: 'POST',
            url: "activityController.do?subGameRecord",
            data: {"score": score,"openId": openId,"accountId": accountId,"activityId": hdid,"deCode":hex_md5(score+openId)},
            dataType: 'json',
            success: function (data) {
            	if (data.attributes.error == "invalid") {
                     Zepto('body').popup({
                         ...
                         , onOk: function () {
                             // 确认按钮的回调函数
                        	 if(hasPhone){window.location.href = rediceUrl;}
                         	else{bindPhoneNumber();}
                         	 flag = true;
                         }
                         , cnacel2: "关闭"
                         , onCancel2: function () {flag = true;}
                     });
                    ...
                    Zepto('body').popup({
                        title: '提示',
                        message: '<h2>本次游戏拼得' +score + '分，获得' + data.attributes.flow + 'M流量。</h2>',
                        id: 'pop-2',
                        ok: anniuText,
                        onOk: function () {
                        	if(hasPhone){window.location.href = rediceUrl;}
