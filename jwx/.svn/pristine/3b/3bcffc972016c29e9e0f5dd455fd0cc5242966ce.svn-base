        ...
        <t:formvalid formid="formobjNew" dialog="true" usePlugin="password" layout="table"
          ...
          <table style="width: 450px;" cellpadding="0" cellspacing="1" class="formtable">
            ...
            <tr>
              ...
              <td class="value">
                <input id="jumptype" name="jumptype" value="" type="text" style="width: 300px"
                       class="inputxt">
          ...
          <table style="width: 500px;" cellpadding="0" cellspacing="1" class="formtable">
            ...
            <tr id="innerurl" style="display:none;">
              ...
              <td class="value">
                <input id="pagetype" name="pagetype" value="" type="text" style="width: 300px"
                       class="inputxt">
            ...
            <tr id="outurl" style="display:none;">
              ...
              <td class="value">
                <input id="pageurl" name="pageurl" value="" type="text" style="width: 300px"
            ...
            <tr id="shareurl" style="display:none;">
                ...
                <td class="value">
                    <input id="shareTitle" name="shareTitle" value="" type="text" style="width: 300px"
                           class="inputxt">
                        <%--<input style="width: 300px" class="easyui-textbox" id="pageurl" name="pageurl" value="${shareItem.pageurl}">--%>
                    <span class="Validform_checktip"></span>
