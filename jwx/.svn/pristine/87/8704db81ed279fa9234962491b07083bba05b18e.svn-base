...
$(function () {
    ...
    var url = 'groupMessageNewsTemplateController.do?upload&type='+type,
    uploadButton = $('<button/>')
...
function getCheckedNews(){
 ...
 <body>
<%-- 
<c:forEach items="${imageList}" var="weixinSource">
	<a href=""><img src="${weixinSource.sourcePath}" width="50px" height="50px"></a>
</c:forEach>
--%>
 	<div class="main_bd">
 		...
 		<div class="media_edit_area" id="js_appmsg_editor">	
 			<div class="appmsg_editor" style="margin-top: 0px;">
	 			<div class="inner" style="width:400px;">
		  		<form id="formobj" action="groupMessageNewsController.do?weixinDoAdd" name="formobj" method="post"><input type="hidden" id="btn_sub" class="btn_sub"/>
